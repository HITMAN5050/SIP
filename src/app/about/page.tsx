...
export default function About() {
  const milestones = [
    ...
    {
      year: "2009",
      title: "AMFI Registration (ARN-165950)",
      desc: "Inspired by our own success, we obtained our Mutual Fund Distributor Code (ARN-165950) registered with AMFI (Association of Mutual Funds in India) to offer structured wealth solutions."
    },
    {
      year: "2015",
            ...
            <div className="lg:col-span-7 glass-card rounded-2xl p-8 space-y-6 text-left shadow-2xl border border-shreeji-border flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-4 text-sm text-shreeji-text-secondary leading-relaxed">
                  ...
                  <p>
                    Motivated by our own investment success and a passion for helping others secure their financial future, we registered as an authorized Mutual Fund Distributor (ARN-165950) with AMFI (Association of Mutual Funds in India).
                  </p>
                  <p>
